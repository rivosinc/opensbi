...
static uint32_t supported_events[] =
{
...
static void sse_event_inject(struct sbi_sse_event *e, struct sbi_sse_event *prev_e,
...
retry:
	...
	if (to_run) {
		...
		/*
		 * Reevaluate readyness, for global events, the hart_id might
